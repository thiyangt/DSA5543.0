...
First take variance of both sides of Equation \textbf{?@eq-ar}
...
\textbf{?@eq-ar} to be weakly stationary is \(|\phi_1| < 1\). This
...
both sides of Equation \textbf{?@eq-ar} by \(Y_{t-k}\) and take expected
values:
