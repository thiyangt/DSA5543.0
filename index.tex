...
\chapter{Spatial Neighbours}\label{spatial-neighbours}

\section{Package}\label{package-1}
...
\section{Visualise data}\label{visualise-data-1}
...
\pandocbounded{\includegraphics[keepaspectratio]{09-chap9_files/figure-pdf/unnamed-chunk-6-1.pdf}}
...
\FunctionTok{ggplot}\NormalTok{(columbus) }\SpecialCharTok{+}
  \FunctionTok{geom\_sf}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nb }\OtherTok{\textless{}{-}} \FunctionTok{poly2nb}\NormalTok{(}\FunctionTok{as}\NormalTok{(columbus, }\StringTok{"Spatial"}\NormalTok{))       }\CommentTok{\# Queen neighbours}
\NormalTok{nb}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coords }\OtherTok{\textless{}{-}} \FunctionTok{st\_coordinates}\NormalTok{(}\FunctionTok{st\_centroid}\NormalTok{(columbus))}
\NormalTok{coords}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(}\FunctionTok{st\_geometry}\NormalTok{(columbus), }\AttributeTok{border =} \StringTok{"grey"}\NormalTok{) }\CommentTok{\# polygons}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{09-chap9_files/figure-pdf/unnamed-chunk-10-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(}\FunctionTok{st\_geometry}\NormalTok{(columbus), }\AttributeTok{border =} \StringTok{"grey"}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(nb, coords, }\AttributeTok{add =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{col =} \StringTok{"red"}\NormalTok{)    }\CommentTok{\# neighbour links}
\FunctionTok{title}\NormalTok{(}\StringTok{"Queen Contiguity Neighbours"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{09-chap9_files/figure-pdf/unnamed-chunk-11-1.pdf}}

\section{Exercise: Compute Rook
Neighbours}\label{exercise-compute-rook-neighbours}

\pandocbounded{\includegraphics[keepaspectratio]{09-chap9_files/figure-pdf/unnamed-chunk-12-1.pdf}}

\section{Compare Rook vs Queen
Neighbours}\label{compare-rook-vs-queen-neighbours}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nb\_queen }\OtherTok{\textless{}{-}} \FunctionTok{poly2nb}\NormalTok{(}\FunctionTok{as}\NormalTok{(columbus, }\StringTok{"Spatial"}\NormalTok{), }\AttributeTok{queen =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{nb\_rook }\OtherTok{\textless{}{-}} \FunctionTok{poly2nb}\NormalTok{(}\FunctionTok{as}\NormalTok{(columbus, }\StringTok{"Spatial"}\NormalTok{), }\AttributeTok{queen =} \ConstantTok{FALSE}\NormalTok{)}
\FunctionTok{lengths}\NormalTok{(nb\_queen)   }\CommentTok{\# neighbours with queen}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{lengths}\NormalTok{(nb\_rook)    }\CommentTok{\# neighbours with rook}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{09-chap9_files/figure-pdf/unnamed-chunk-14-1.pdf}}

\bookmarksetup{startatroot}

\chapter{Spatial Data Science}\label{spatial-data-science}

Link to slides:
\url{https://thiyangt.github.io/spatialmodellingversion2/\#/title-slide}

\bookmarksetup{startatroot}

\chapter{Interactive Map
Visualisation}\label{interactive-map-visualisation}
...
\section{Static Plot}\label{static-plot}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(province) }\SpecialCharTok{+} 
  \FunctionTok{geom\_sf}\NormalTok{(}\AttributeTok{mapping =} \FunctionTok{aes}\NormalTok{(}\AttributeTok{fill =}\NormalTok{ population), }\AttributeTok{show.legend =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{scale\_fill\_viridis}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{11-chap11_files/figure-pdf/unnamed-chunk-3-1.pdf}}

\section{Using mapview}\label{using-mapview}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mapview}\NormalTok{(}
\NormalTok{  province,}
  \AttributeTok{zcol =} \StringTok{"population"}\NormalTok{,}
  \AttributeTok{legend =} \ConstantTok{TRUE}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{11-chap11_files/figure-pdf/unnamed-chunk-4-1.pdf}}

\section{Using leaflet}\label{using-leaflet}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m }\OtherTok{\textless{}{-}} \FunctionTok{leaflet}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{addTiles}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}  \CommentTok{\# OpenStreetMap tiles}
  \FunctionTok{addMarkers}\NormalTok{(}
    \AttributeTok{lng =} \FloatTok{79.8612}\NormalTok{,}
    \AttributeTok{lat =} \FloatTok{6.9271}\NormalTok{,}
    \AttributeTok{popup =} \StringTok{"Colombo, Sri Lanka"}
\NormalTok{  )}
\NormalTok{m}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{11-chap11_files/figure-pdf/unnamed-chunk-5-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#htmltools::save\_html(m, file = "../HtmlWidget/leaflet{-}sri{-}lanka.html")}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{leaflet}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{addMarkers}\NormalTok{(}
    \AttributeTok{lng =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\FloatTok{118.2437}\NormalTok{, }\SpecialCharTok{{-}}\FloatTok{74.0060}\NormalTok{),}
    \AttributeTok{lat =} \FunctionTok{c}\NormalTok{(}\FloatTok{34.0522}\NormalTok{, }\FloatTok{40.7128}\NormalTok{),}
    \AttributeTok{popup =} \FunctionTok{c}\NormalTok{(}\StringTok{"Los Angeles, CA"}\NormalTok{, }\StringTok{"New York City, NY"}\NormalTok{)}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{addRectangles}\NormalTok{(}
    \AttributeTok{lng1 =} \FloatTok{79.6}\NormalTok{, }\AttributeTok{lat1 =} \FloatTok{5.9}\NormalTok{,   }\CommentTok{\# bottom{-}left}
    \AttributeTok{lng2 =} \FloatTok{81.9}\NormalTok{, }\AttributeTok{lat2 =} \FloatTok{9.9}\NormalTok{,   }\CommentTok{\# top{-}right}
    \AttributeTok{fill =} \ConstantTok{FALSE}\NormalTok{,}
    \AttributeTok{color =} \StringTok{"red"}\NormalTok{,}
    \AttributeTok{weight =} \DecValTok{2}\NormalTok{,}
    \AttributeTok{popup =} \StringTok{"Sri Lanka Bounding Box"}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{11-chap11_files/figure-pdf/unnamed-chunk-6-1.pdf}}

\section{Exercise}\label{exercise-5}

Write the code to obtain the following plot

\pandocbounded{\includegraphics[keepaspectratio]{11-chap11_files/figure-pdf/unnamed-chunk-7-1.pdf}}

\bookmarksetup{startatroot}

\chapter{\texorpdfstring{\texttt{meuse}
dataset}{meuse dataset}}\label{meuse-dataset}
...
\FunctionTok{head}\NormalTok{(meuse)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{(meuse.grid)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{meuse }\OtherTok{\textless{}{-}} \FunctionTok{st\_as\_sf}\NormalTok{(meuse, }\AttributeTok{coords =} \FunctionTok{c}\NormalTok{(}\StringTok{"x"}\NormalTok{, }\StringTok{"y"}\NormalTok{), }\AttributeTok{crs =} \DecValTok{28992}\NormalTok{)}
\NormalTok{meuse}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mapview}\NormalTok{(meuse, }\AttributeTok{zcol =} \StringTok{"zinc"}\NormalTok{,  }\AttributeTok{map.types =} \StringTok{"CartoDB.Voyager"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{12-chap12_files/figure-pdf/unnamed-chunk-1-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{meuse.grid }\OtherTok{\textless{}{-}} \FunctionTok{st\_as\_sf}\NormalTok{(meuse.grid, }\AttributeTok{coords =} \FunctionTok{c}\NormalTok{(}\StringTok{"x"}\NormalTok{, }\StringTok{"y"}\NormalTok{),}
                       \AttributeTok{crs =} \DecValTok{28992}\NormalTok{)}
\FunctionTok{mapview}\NormalTok{(meuse.grid,  }\AttributeTok{map.types =} \StringTok{"CartoDB.Voyager"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{12-chap12_files/figure-pdf/unnamed-chunk-1-2.pdf}}

\section{Variogram Cloud}\label{variogram-cloud}
...
\CommentTok{\# Load Meuse data}
\FunctionTok{data}\NormalTok{(meuse)}
\FunctionTok{coordinates}\NormalTok{(meuse) }\OtherTok{\textless{}{-}} \ErrorTok{\textasciitilde{}}\NormalTok{x}\SpecialCharTok{+}\NormalTok{y}

\CommentTok{\# Log{-}transform zinc}
\NormalTok{meuse}\SpecialCharTok{$}\NormalTok{logZinc }\OtherTok{\textless{}{-}} \FunctionTok{log}\NormalTok{(meuse}\SpecialCharTok{$}\NormalTok{zinc)}
\CommentTok{\# Compute variogram cloud (all pairs, raw semivariance)}
\NormalTok{cloud }\OtherTok{\textless{}{-}} \FunctionTok{variogram}\NormalTok{(logZinc}\SpecialCharTok{\textasciitilde{}}\DecValTok{1}\NormalTok{, meuse, }\AttributeTok{cloud =} \ConstantTok{TRUE}\NormalTok{)}

\CommentTok{\# View first few points}
\FunctionTok{head}\NormalTok{(cloud)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Plot variogram cloud}
\FunctionTok{plot}\NormalTok{(cloud}\SpecialCharTok{$}\NormalTok{dist, cloud}\SpecialCharTok{$}\NormalTok{gamma,}
     \AttributeTok{xlab =} \StringTok{"Distance (m)"}\NormalTok{,}
     \AttributeTok{ylab =} \StringTok{"Semivariance"}\NormalTok{,}
     \AttributeTok{main =} \StringTok{"Variogram Cloud"}\NormalTok{,}
     \AttributeTok{pch =} \DecValTok{19}\NormalTok{, }\AttributeTok{col =} \StringTok{"blue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{12-chap12_files/figure-pdf/unnamed-chunk-2-1.pdf}}

\section{h-scatterplot}\label{h-scatterplot}
...
\FunctionTok{hscat}\NormalTok{(}\FunctionTok{log}\NormalTok{(zinc)}\SpecialCharTok{\textasciitilde{}}\DecValTok{1}\NormalTok{, meuse, }\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{80}\NormalTok{, }\DecValTok{120}\NormalTok{, }\DecValTok{250}\NormalTok{, }\DecValTok{500}\NormalTok{, }\DecValTok{1000}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{12-chap12_files/figure-pdf/unnamed-chunk-3-1.pdf}}

\section{Sample variogram}\label{sample-variogram}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{v }\OtherTok{\textless{}{-}} \FunctionTok{variogram}\NormalTok{(}\FunctionTok{log}\NormalTok{(zinc) }\SpecialCharTok{\textasciitilde{}} \DecValTok{1}\NormalTok{, }\AttributeTok{data =}\NormalTok{ meuse)}
\FunctionTok{plot}\NormalTok{(v)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{12-chap12_files/figure-pdf/unnamed-chunk-4-1.pdf}}
